...
def crear():
    ...
    formulario = SQLFORM(db.otorgamiento)    

    if formulario.process().accepted:
        response.flash = 'Se ha registrado el otorgamiento'     
...
def administrar():
    ...
    db.otorgamiento.id.readable=False
    grid = SQLFORM.grid(db.otorgamiento, editable=True, paginate=False, details=False, csv=False, user_signature=False, searchable=False, create=False)

...
def crear():
    ...
    formulario = SQLFORM(db.fechas)    

    if formulario.process().accepted:
        response.flash = 'Se ha registrado la fecha'     
...
def administrar():
    ...
    db.fechas.id.readable=False
    grid = SQLFORM.grid(db.fechas, editable=True, details=False, csv=False, paginate=False, user_signature=False, searchable=False, create=False)
